...
entrypoints = ["./dev help", "./dev setup", "./dev check-local", "./dev check", "./dev fmt", "./dev test-e2e", "./dev test-shopware-e2e", "./dev fixtures", "./dev mock", "./dev site-record", "./dev image", "./dev proof", "./dev release", "./dev clean", "python -m cdpx.proof"]
